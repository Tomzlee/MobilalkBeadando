...
public class AdminAdapter extends RecyclerView.Adapter<AdminAdapter.ViewHolder> implements Filterable {
    ...
    AdminAdapter(Context context, ArrayList<KurzusItem> itemsData){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(mContext).inflate(R.layout.admin_list_item, parent, false));
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder( View itemView) {
            ...
            ujArET = itemView.findViewById(R.id.adminArEditText);
        ...
        public void bindTo(KurzusItem currentItem) {
            ...
            String ujAr = ujArET.getText().toString();

            Glide.with(mContext).load(currentItem.getImageResource()).into(mItemImage);

            itemView.findViewById(R.id.adminDeleteButton).setOnClickListener(view -> ((AdminActivity)mContext).deleteItem(currentItem));
            itemView.findViewById(R.id.adminArUpdateButton).setOnClickListener(view -> ((AdminActivity)mContext).updateAr(currentItem,ujArET));
        }
    }
}

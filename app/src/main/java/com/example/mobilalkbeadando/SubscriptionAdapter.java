...
public class SubscriptionAdapter extends RecyclerView.Adapter<SubscriptionAdapter.ViewHolder> implements Filterable {
    ...
    SubscriptionAdapter(Context context, ArrayList<KurzusItem> itemsData){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(mContext).inflate(R.layout.subscribed_list_item, parent, false));
    }
